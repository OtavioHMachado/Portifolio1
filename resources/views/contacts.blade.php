  ...
  <body>
    ...
    <div class="page text-center">
      <header class="page-head slider-menu-position">
          ...
          <nav class="rd-navbar container rd-navbar-floated rd-navbar-dark" data-md-device-layout="rd-navbar-fixed" data-lg-device-layout="rd-navbar-static" data-lg-auto-height="true" data-md-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-static" data-lg-stick-up="true">
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-panel">
                ...
                <div class="rd-navbar-brand"><a href="index"><img width='173' height='30' src='images/logo.png' alt=''/></a></div>
              </div>
              <div class="rd-navbar-menu-wrap">
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-mobile-scroll">
                    <div class="rd-navbar-mobile-brand"><a href="index"><img width='173' height='30' src='images/logo.png' alt=''/></a></div>
                    <ul class="rd-navbar-nav">
                      <li><a href="/"><span>Home</span></a></li>
                      <li><a href="about-coach"><span>About Coach</span></a></li>
                      <li class="active"><a href="contacts"><span>Contact Us</span></a></li>
                    </ul>
                  </div>
                </div>
              </div>
        ...
        <div class="context-dark">
          <section>
            <div class="parallax-container breadcrumb-modern bg-gray-darkest" data-parallax-img="images/wallpapergym.png">
          ...
          <div class="row justify-content-sm-center justify-content-sm-center">
            <div class="col-xl-4">
              <div class="inset-xl-right-80">
                ...
                <p class="offset-top-41 offset-xl-top-50">We are located in the city center and it's easy to reach us with any kind of public transport. Use our map to find the nearest gym.</p>
                <address class="contact-info offset-top-30 offset-xl-top-50">
                  <div class="h6 text-uppercase font-weight-bold text-danger letter-space-none offset-top-none">Cambridge</div>
